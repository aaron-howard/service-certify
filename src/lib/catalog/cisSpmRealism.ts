...
export const CIS_SPM_DOMAIN_TARGETS = {
	...
	'Timecard Management': 5,
	'Portfolio Planning Workspace': 7,
	'SPM Platform Analytics and Dashboards': 2,
...
export function validateCisSpmQuestion(q: CisSpmQuestionRow): string[] {
	const issues: string[] = [];
	if (q.trackCode !== 'CIS-SPM') return issues;
