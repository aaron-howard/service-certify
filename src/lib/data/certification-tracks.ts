/**
 * Official ServiceNow certification tracks (exam code → certification name).
 * Keep in sync with `src/convex/catalog/tracksCanonical.ts` (Convex seed).
 */
export const certificationTracks: { code: string; officialCertificationName: string }[] = [
	...
	{ code: 'CIS-DF', officialCertificationName: 'Certified Implementation Specialist - Data Foundations' },
	{
		code: 'CIS-PA',
