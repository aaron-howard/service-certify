...
import {
	...
	validateCisFsmTrack
} from '$lib/catalog/cisFsmRealism';
...
describe('CIS-FSM v2 realism (full track)', () => {
	...
	it('meets scenario-style minimum across the v2 bank', () => {
		...
		expect(scenarioCount / CIS_FSM_BANK_SIZE).toBeGreaterThanOrEqual(0.65);
	});
