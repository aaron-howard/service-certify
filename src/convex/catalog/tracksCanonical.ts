/**
 * Seed source for `certificationTracks` table. Must match
 * `src/lib/data/certification-tracks.ts` (run `npm run check` after edits).
 */
export const CERTIFICATION_TRACKS_FOR_SEED: { code: string; officialCertificationName: string }[] =
	[
