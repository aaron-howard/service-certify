...
import { DEV_PRACTICE_QUESTIONS } from '../src/convex/seed/devQuestionBank.private.ts';
...
const outPath = path.join(path.dirname(fileURLToPath(import.meta.url)), '..', 'src/convex/seed/devQuestionBank.private.ts');
